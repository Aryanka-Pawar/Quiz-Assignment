...
import 'package:quiz_assignment/Model/exam_model.dart';
import 'package:quiz_assignment/Pages/all_quiz_page.dart';
import 'package:quiz_assignment/Pages/quiz_page.dart';
import 'package:quiz_assignment/Shared/constants.dart';
import 'package:quiz_assignment/Shared/custom_appbar.dart';
import 'package:quiz_assignment/splashScreen.dart';
                  ...
                  CustomButton(
                    ...
                    onPressed: (){
                      ...
                      if(DateTime.now().isAfter(examModel.examInitialDate) && DateTime.now().isBefore(examModel.examFinalDate)){
                        ...
                        showMessage(context, "See exam date and time.\nYou can not take test right now!");
                      }
                    },
                  ),
                ],
